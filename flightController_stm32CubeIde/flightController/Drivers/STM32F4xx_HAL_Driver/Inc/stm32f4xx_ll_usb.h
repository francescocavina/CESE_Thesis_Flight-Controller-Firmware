...
typedef enum { USB_DEVICE_MODE = 0,
               USB_HOST_MODE   = 1,
               USB_DRD_MODE    = 2 } USB_OTG_ModeTypeDef;

/**
 * @brief  URB States definition
 */
typedef enum { URB_IDLE = 0,
               URB_DONE,
               URB_NOTREADY,
               URB_NYET,
               URB_ERROR,
               URB_STALL } USB_OTG_URBStateTypeDef;
...
typedef enum { HC_IDLE = 0,
               ...
               HC_XACTERR,
               HC_BBLERR,
               HC_DATATGLERR } USB_OTG_HCStateTypeDef;
